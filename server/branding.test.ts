...
import { LS_SOLUTIONS_NAME, LS_SOLUTIONS_LOGO_URL, ORBITA_BRAND_NAME, ORBITA_LOGO_URL, SIDEBAR_LOGO_TARGET, SIDEBAR_COLLAPSED_STORAGE_KEY } from "../client/src/branding";
...
describe("Orbita branding asset", () => {
  it("uses the transparent PNG storage asset consistently", () => {
    ...
    expect(LS_SOLUTIONS_LOGO_URL).toBe("/ls-logo.png");

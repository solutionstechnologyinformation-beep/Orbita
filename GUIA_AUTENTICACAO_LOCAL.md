...
5. **Histórico de Auditoria e Alertas de Segurança**: Cada transição no ciclo de vida do convite é registrada automaticamente com data, IP e identificador. O painel exibe contadores de risco em destaque e um filtro rápido para isolar tentativas de acesso a convites expirados ou revogados, permitindo auditoria proativa de segurança.
